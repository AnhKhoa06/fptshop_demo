...
?>
<title>Smart Phone | Xiaomi 14T 5G</title>
...
<div class="breadcrumb">
    ...
    <a href="../brand/oppo.php">Oppo</a>
        <i class="fa-solid fa-angle-right"></i>
    <span>Xiaomi 14T 5G</span>
</div>


<?php
// Giả định product_id của iPhone 15 là 1
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 9; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 9; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        $brand_id = $current_product['brand_id'] ?? 9; // Giả định brand_id của iPhone là 1
