...
?>
<title>Smart Phone | Samsung S23 256GB</title>
...
<div class="breadcrumb">
    ...
    <a href="../index.php">Điện thoại</a>
        <i class="fa-solid fa-angle-right"></i>
    <a href="../brand/apple-iphone.php">Samsung (Galaxy)</a>
        <i class="fa-solid fa-angle-right"></i>
...
$product_id = 2; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 2; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 2; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        $brand_id = $current_product['brand_id'] ?? 2; // Giả định brand_id của iPhone là 1
