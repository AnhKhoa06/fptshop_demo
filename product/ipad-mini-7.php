...
?>
<title>Smart Phone | Ipad Mini 7</title>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 82; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 82; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 82; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
