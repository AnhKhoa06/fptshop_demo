...
?>
<title>Smart Phone | Xiaomi Redmi 9 128GB</title>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 13; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 13; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        <?php
        // Lấy thông tin sản phẩm hiện tại
        $product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 13;
        ...
        $brand_id = $current_product['brand_id'] ?? 13; // Giả định brand_id của iPhone là 1
