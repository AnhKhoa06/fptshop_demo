...
?>
<title>Smart Phone | Realme 10 Pro 256GB</title>
...
<div class="breadcrumb">
    ...
    <a href="../index.php">Điện thoại</a>
        <i class="fa-solid fa-angle-right"></i>
    <a href="../brand/realme.php">Realme</a>
        <i class="fa-solid fa-angle-right"></i>
    <span>Realme 10 Pro</span>
</div>


<?php
// Giả định product_id của iPhone 15 là 1
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 10; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 6; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 10; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        <?php
        // Lấy thông tin sản phẩm hiện tại
        $product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 10;
        ...
        $brand_id = $current_product['brand_id'] ?? 10; // Giả định brand_id của iPhone là 1
