...
?>
<title>Smart Phone | Oppo Pad 3</title>
...
<div class="breadcrumb">
    ...
    <a href="../brand/oppo_tablet.php">Oppo-Tablet</a>
        <i class="fa-solid fa-angle-right"></i>
    <span>Oppo Pad 3</span>
</div>


<?php
// Giả định product_id của iPhone 15 là 1
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 85; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 85; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 85; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
