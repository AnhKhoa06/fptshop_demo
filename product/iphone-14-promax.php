...
?>
<title>Smart Phone | iPhone 14 Promax 512GB</title>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 7; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 7; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        <?php
        // Lấy thông tin sản phẩm hiện tại
        $product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 7;
        ...
        $brand_id = $current_product['brand_id'] ?? 7; // Giả định brand_id của iPhone là 1
