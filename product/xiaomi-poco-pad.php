...
?>
<title>Smart Phone | Xiaomi Poco Pad</title>
...
<div class="breadcrumb">
    ...
    <a href="../index.php">Máy tính bảng</a>
        <i class="fa-solid fa-angle-right"></i>
    <a href="../brand/xiaomi_tablet.php">Xiaomi</a>
        <i class="fa-solid fa-angle-right"></i>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 87; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 87; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 87; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
