...
?>
<title>Smart Phone | iPhone 15 128GB</title>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 1; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
$brand_id_iphone = 1; // Giả định brand_id của Apple (iPhone) là 1, bạn cần thay đổi theo thực tế
...
<div id="product-container" class="product-detail">
    ...
    <div class="product-right">
        ...
        $brand_id = $current_product['brand_id'] ?? 1; // Giả định brand_id của iPhone là 1
