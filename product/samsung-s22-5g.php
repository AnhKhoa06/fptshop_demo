...
?>
<title>Smart Phone | Samsung S22 256GB</title>
...
$product_id = isset($_GET['product_id']) ? (int)$_GET['product_id'] : 6; // Thay đổi ID này dựa trên sản phẩm thực tế, ví dụ: lấy từ $_GET['id']
...
<div id="product-container" class="product-detail">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="reviews">
                    ...
                    if (!$connect) {
                        ...
                        // Truy vấn đánh giá
                        $product_id = 6; // Thay bằng ID sản phẩm thực tế (ví dụ: từ $_GET['product_id'])
    ...
    <div class="product-right">
        ...
        $brand_id = $current_product['brand_id'] ?? 6; // Giả định brand_id của iPhone là 1
