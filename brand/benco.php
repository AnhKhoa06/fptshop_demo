...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 9 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 9 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 9 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 9 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Benco</title>
...
<h2 class="brand-title">
    <img src="../img/bencologo.png" alt="Benco Logo" class="brand-logo" style="width: 113px; height: 38px; transform: translateX(60px);">
