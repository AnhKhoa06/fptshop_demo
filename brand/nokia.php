...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 25 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 25 ORDER BY price_discount ASC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 25 ORDER BY prd_id ASC LIMIT 20";
}
?>
...
<h2 class="brand-title">
    <img src="../img/nokialogo.png" alt="Nokia Logo" class="brand-logo" style="width: 100px; height: 25px; transform: translateX(60px);">
