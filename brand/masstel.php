...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 13 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 13 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 13 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 13 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Masstel</title>
...
<h2 class="brand-title">
    <img src="../img/masstellogo.png" alt="Masstel Logo" class="brand-logo" style="width: 110px; height: 34px; transform: translateX(60px);">
