...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 28 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 28 ORDER BY price_discount ASC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 28 ORDER BY prd_id ASC LIMIT 20";
}
?>
