...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 7 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 7 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 7 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 7 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Tecno</title>
...
<h2 class="brand-title">
    <img src="../img/tecno1.png" alt="Tecno Logo" class="brand-logo" style="width: 97px; height: 24px; transform: translateX(56px);">
