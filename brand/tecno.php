...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 20 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 20 ORDER BY price_discount ASC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 20 ORDER BY prd_id ASC LIMIT 20";
}
?>
...
<h2 class="brand-title">
    <img src="../img/tecno1.png" alt="Tecno Logo" class="brand-logo" style="width: 120px; height: 24px; transform: translateX(56px);">
    ...
    <div class="product-display">
        <div class="product-list">
            ...
            <div class="product">
                ...
                <a href="/product/<?php echo $row['prd_id']; ?>.html?name=<?php echo urlencode($row['prd_name']); ?>">
