...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 11 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 11 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 11 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 11 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Tcl</title>
...
<h2 class="brand-title">
    <img src="../img/tcllogo.png" alt="TCL Logo" class="brand-logo" style="width: 100px; height: 36px; transform: translateX(60px);">
