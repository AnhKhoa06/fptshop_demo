...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 5 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 5 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 5 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 5 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Honor</title>
...
<h2 class="brand-title">
    <img src="../img/honor.png" alt="Honor Logo" class="brand-logo" style="width: 110px; height: 26px; transform: translateX(60px);">
        ...
        <div class="product-list">
            ...
            <div class="product">
                ...
                <div class="product-badges">
                    <img src="../img/baohanh3.png" alt="5 tháng bảo hành" class="badge">
