...
if ($sort === 'high_to_low') {
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 17 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 17 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Asus</title>
...
<h2 class="brand-title">
    <img src="../img/asus.webp" alt="Samsung Logo" class="brand-logo" style="width: 100px; vertical-align: middle; margin-left: 50px;">
