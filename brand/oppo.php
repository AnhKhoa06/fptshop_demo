...
if ($sort === 'high_to_low') {
    $sql = "SELECT * FROM products WHERE brand_id = 3 ORDER BY price_discount DESC LIMIT 20";
} elseif ($sort === 'low_to_high') {
    $sql = "SELECT * FROM products WHERE brand_id = 3 ORDER BY price_discount ASC LIMIT 20";
    ...
    $sql = "SELECT * FROM products WHERE brand_id = 3 ORDER BY views DESC LIMIT 20";
} else {
    $sql = "SELECT * FROM products WHERE brand_id = 3 ORDER BY prd_id ASC LIMIT 20";
}
?>
<title>Smart Phone | Oppo</title>
...
<h2 class="brand-title">
    <img src="../img/logo-oppo-2.png" alt="Oppo Logo" class="brand-logo" style="width: 75px; height: 27px; transform: translateX(60px);">
        ...
        <div class="product-list">
            ...
            <div class="product">
                ...
                <div class="product-badges">
                    <img src="../img/baohanh1.png" alt="18 tháng bảo hành" class="badge">
